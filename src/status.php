...
<body class="container">
  <header class="header">
    ...
    <ul class="menu">
      ...
      <li>
        <a>
          <form action="php/wyloguj.php"><input class="logout" type="submit" name="wyloguj" value="Wyloguj"></input></form>
        </a>
      </li>
    </ul>
  </header>
  ...
  else
  {
    ...
    echo ("   </td>");
    echo ("  <td class='select'>
    <form method='post' action='stat.php'><button class='button' name='status' action='php/stat.php'>Restart</button></form>
   ...
   if ($ssh = !"active")
   {
    ...
    echo ("   </td>");
    echo ("  <td class='select'>");
    echo (" <button class='button' name='status' action='php/stat.php'>Wylacz</button>
    <button class='button' onClick='window.location.reload();'>Odswież</button>");
    echo ("  </tr>");
   }
   else 
   {
     ...
     echo ("   </td>");
     echo ("  <td class='select'>
     <button class='button' name='status' action='php/stat.php'>Restart</button>
     <button class='button' onClick='window.location.reload();'>Odswież</button> </td>");
     echo ("  </tr>");
    }
    if ($www = !"active")
    ...
    else 
    {
      ...
      echo ("   </td>");
      echo ("  <td class='select'>
      <button class='button' name='status' action='php/stat.php'>Restart</button></form>
      <button class='button' onClick='window.location.reload();'>Odswież</button> </td>");
      echo ("  </tr>");
     }
  ?>
   <tfoot>
      ...
      <form method="post" action="php/usun.php">
